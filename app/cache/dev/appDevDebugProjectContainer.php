...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8dca8419e011dcc6a548bf93d06b4df4380c8d11b860dad2d08176109c7af909');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('rahul.p@wwindia.com');
        $a->setPassword('rahulp123');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('smtp.wwindia.com');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_host' => 'smtp.wwindia.com',
            'mailer_user' => 'rahul.p@wwindia.com',
            'mailer_password' => 'rahulp123',
            'mailer_port' => 587,
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.wwindia.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'rahul.p@wwindia.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'rahulp123',
