...
class User extends \AdminBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\User' . "\0" . 'fullname', '' . "\0" . 'AdminBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'AdminBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'AdminBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'AdminBundle\\Entity\\User' . "\0" . 'city', '' . "\0" . 'AdminBundle\\Entity\\User' . "\0" . 'country', '' . "\0" . 'AdminBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'AdminBundle\\Entity\\User' . "\0" . 'deleted', '' . "\0" . 'AdminBundle\\Entity\\User' . "\0" . 'createdon', '' . "\0" . 'AdminBundle\\Entity\\User' . "\0" . 'updatedon');
        }
    ...
    public function setCreatedon()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCreatedon', array());

        return parent::setCreatedon();
    }
